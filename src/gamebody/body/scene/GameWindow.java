...
import gamebody.body.characters.*;
import gamebody.body.items.Dynamite;
...
public class GameWindow extends JFrame implements Runnable, KeyListener {
    ...
    public void keyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_DOWN) {            // 当按下“↓”键时。
            if (rope.getCurrentState() == RopeState.SWING && isInMainScene) { // 当绳索处于摆动状态的时候。
